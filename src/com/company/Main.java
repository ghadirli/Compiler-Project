...
//        Lexer checkLexer = new Lexer(sampleInputDirectory + "/Parser_sample_input", sampleOutputDirectory + "/scanner.txt", sampleOutputDirectory + "/lexical_errors.txt");
//        checkLexer.analyzer();
//        Token curToken = null;
//        do{
...
//        } while (curToken.getTokenType() != TokenTypes.EOF);
        ...
        Lexer lexer = new Lexer(sampleInputDirectory + "/Parser_sample4", sampleOutputDirectory + "/scanner.txt", sampleOutputDirectory + "/lexical_errors.txt");
